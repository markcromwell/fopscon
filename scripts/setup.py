'''
setup.py — Install Foundation Operator Console on a new machine.
...
def run_install(args):
    print(_BOLD("\n=== Foundation Operator Console installer ===\n"))
    ...
    if wait_healthy(health_url):
        print(_GREEN("\nFoundation Operator Console is up and healthy."))
        print(f"\nNext steps:")
...
def run_check(args):
    print(_BOLD("\n=== Foundation Operator Console install check ===\n"))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Foundation Operator Console installer")
